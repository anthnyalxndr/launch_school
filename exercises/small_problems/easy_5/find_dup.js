...
function findDup(arr) {
  // Add elements & their count to a hash map as you loop
  // through the arr
  let map = {};

  // As soon as you come across a property in the hash map
  // whose count is already 1, return the dup.
  for (let idx = 0; idx < arr.length; idx += 1) {
    if (map[arr[idx]] === 1) return arr[idx];
    else map[arr[idx]] = 1;
  }
...
// Examples
console.log(findDup([1, 5, 3, 1]) === 1);                                // 1
